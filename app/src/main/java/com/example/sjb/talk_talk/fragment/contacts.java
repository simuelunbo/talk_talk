...
import com.example.sjb.talk_talk.activity.Register;
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater,  ViewGroup container, Bundle savedInstanceState) {
        RelativeLayout layout = (RelativeLayout)inflater.inflate(R.layout.contacts, container, false);
        ...
        recyclerView = (RecyclerView) layout.findViewById(R.id.contacts_recyclerview);
        mLayoutManager = new LinearLayoutManager(getActivity());
        mLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        textView = (TextView) layout.findViewById(R.id.friend_count);

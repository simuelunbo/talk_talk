...
public abstract class  GoCoderSDKActivityBase extends Activity
    ...
    private static final String SDK_SAMPLE_APP_LICENSE_KEY = "GOSK-FF45-010C-79E9-EBBE-98AD";
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                if (goCoderStatus.isReady()) {
                    ...
                    // 서버 연결을 성공적으로 열었으므로 연결 정보를 저장하여 자동 완료
...
//                mWZBroadcastConfig.setFrameRateLowBandwidthSkipCount(1);
    ...
    protected void displayErrorDialog(String errorMessage) {
        ...
        try {
            if(errorMessage.equals("Playback cannot continue."))
            {
                errorMessage = "이미 종료된 방송 입니다.";
            }

...
public class Add_friendRequest extends StringRequest {

    final static private String URL = "http://115.71.239.124/talktalk/add_friend.php";
    private Map<String, String> parameters;

    public Add_friendRequest(String userEmail, String userName, String userGoogle, String friendEmail, String friendName,
